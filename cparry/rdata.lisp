...
; WORDS INCLUDE PATTERN MATCHER CANONICAL WORDS, RDATA SPECIAL WORDS, AND PDAT TOPIC NAMES
 ...
 (EDUCATION (EDUCATION SCHOOL) WORDS)
...
;; here sensitivelist is nil
;;; setlist is not nil, because it hs no weights
...
(SETQ STL '(
  (MAFIASET ( @@1010  ) STORY)
  (RACKETSET  (  @@0880   )  STORY)
  (GANGSTERSET ( @@0860 @@0860  )  STORY)
  (PERSONSET  ( @@0870 @@0870  )  STORY)
  (CHEATSET  ( @@0900 @@0900  )  STORY)
  (BOOKIESET  ( @@0920 @@0930  )  STORY)
  (GAMBLERSET  ( @@0940 @@0940  )  STORY)
  (MONEYSET  ( @@0960 @@0960  )  STORY)
  (HORSERACINGSET  ( @@0970 @@0972  ) STORY)
  (POLICESET  ( @@0980 @@0980  )  STORY)
  (ITALIANSET  ( @@0990 @@0990  )  STORY)
  (HORSESET  ( @@1000 @@1000  )  STORY)
  ...
  (FAMILY(@@0730 @@0732 ) STORY)
  (EDUCATION ( @@1540 @@1550 ) STORY)
  (HOSPITAL(  @@0100  @@0210) STORY)
  (HOBBIES(  @@0760  @@0770) STORY)
  (GIRL( @@0660  @@0690) STORY)
  (SERVICE( @@0500 @@0510) STORY)
  (SEXLIFE(  @@1690) STORY)
  (RESIDENCE( @@2290 @@2330) STORY)
  (WORK( @@0460 @@0462 @@0490) STORY)
  (SWEARING (  @@2410) STORY)
  ))
